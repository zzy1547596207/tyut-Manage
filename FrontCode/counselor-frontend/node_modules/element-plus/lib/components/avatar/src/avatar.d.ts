...
declare const avatarProps: {
  ...
  readonly fit: EpPropFinalized<(new (...args: any[]) => "none" | "-moz-initial" | "inherit" | "initial" | "revert" | "revert-layer" | "unset" | "fill" | "contain" | "cover" | "scale-down") | (() => _$csstype.Property.ObjectFit | undefined) | (((new (...args: any[]) => "none" | "-moz-initial" | "inherit" | "initial" | "revert" | "revert-layer" | "unset" | "fill" | "contain" | "cover" | "scale-down") | (() => _$csstype.Property.ObjectFit | undefined)) | null)[], unknown, unknown, "cover", boolean>;
};
/**
 * @deprecated Removed after 3.0.0, Use `AvatarProps` instead.
 */
