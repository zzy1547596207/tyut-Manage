...
declare const __VLS_export: _$vue.DefineComponent<_$vue.ExtractPropTypes<{
  ...
  readonly type: {
    readonly type: _$vue.PropType<EpPropMergeType<(new (...args: any[]) => "" | "text" | "default" | "info" | "primary" | "success" | "warning" | "danger") | (() => "" | "text" | "default" | "info" | "primary" | "success" | "warning" | "danger") | (((new (...args: any[]) => "" | "text" | "default" | "info" | "primary" | "success" | "warning" | "danger") | (() => "" | "text" | "default" | "info" | "primary" | "success" | "warning" | "danger")) | null)[], unknown, unknown>>;
    readonly required: false;
    readonly validator: ((val: unknown) => boolean) | undefined;
    __epPropKey: true;
  };
